# CNN-based-Handwritten-Equation-Interpreter with Web App
...
https://github.com/Aryansh-kr/Automotive-Insurance-Fraud-Interception/assets/127012188/e3a5b48c-b7f4-436b-8e28-362bc14362d1
...
1. **Exploring Notebooks**: Navigate to the `Notebook.ipynb` directory to explore Jupyter notebooks. These notebooks cover data analysis, preprocessing, model training, and evaluation steps.
   -  Navigate to the `Notebook.ipynb`
   -  Run all the cells
2. **Trained Models**: The `model_weights/` directory contains trained Deep Learning models saved in HDF5 format. These models can be loaded and used for making predictions.
